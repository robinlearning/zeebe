...
public class ClaimedFragment {
  ...
  private BiConsumer<Long, QuadConsumer<ZeebeEntry, Long, Integer, Integer>> addHandler;
  ...
  public void wrap(
      ...
      final BiConsumer<Long, QuadConsumer<ZeebeEntry, Long, Integer, Integer>> addHandler) {
  ...
  public void commit(
      long claimedPosition, final QuadConsumer<ZeebeEntry, Long, Integer, Integer> handler) {
