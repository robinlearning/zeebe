...
public class Dispatcher extends Actor {
  ...
  private final Map<Long, QuadConsumer<ZeebeEntry, Long, Integer, Integer>> handlers =
  ...
  private void addHandler(
      final Long position, final QuadConsumer<ZeebeEntry, Long, Integer, Integer> handler) {
  ...
  private long offer(
    ...
    if (!isClosed) {
      ...
      if (position < limit) {
        ...
        // TODO(miguel): why is this called here?
        signalSubscriptions();
      }
    }
